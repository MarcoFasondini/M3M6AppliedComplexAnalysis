...
\cent{\includegraphics[width=0.8\linewidth]{C:/Users/mfaso/OneDrive/Documents/GitHub/M3M6AppliedComplexAnalysis/output/figures/Lecture9_6_1.pdf}}
...
& \approx {f(x) + f'(x) h + f''(x) h^2/2 - 2 f(x) + f(x) - f'(x) h + f''(x) h^2/2  \over h^2}= f''(x)
\end{align*}
\newpage
...
\]
but $\E^{- \zeta^\alpha t }$ has a branch point right at 0. Fortunately in this case we have more understanding of the spectrum of $\Delta_N$. 
\newpage
In particular, for
...
\end{align*}
The second term is zero when $\theta = \theta_j = j \pi / (N+1)$, thus we know the eigenvalues of $\Delta$ are $\lambda_j = 2 \cos \theta_j$ for $j = 1,\ldots,N$. ($j = 0$ is not valid as then the "eigenvector" would be zero.) 
\newpage
...
%     (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(          (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*( 
%     (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(          (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*( 
%     (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(   (*@\ensuremath{\ldots}@*(   400.0      (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*(       (*@\ensuremath{\cdot}@*( 
...
\cent{\includegraphics[width=0.65\linewidth]{C:/Users/mfaso/OneDrive/Documents/GitHub/M3M6AppliedComplexAnalysis/output/figures/Lecture9_9_1.pdf}}
...
\cent{\includegraphics[width=0.7\linewidth]{C:/Users/mfaso/OneDrive/Documents/GitHub/M3M6AppliedComplexAnalysis/output/figures/Lecture9_10_1.pdf}}
...
\cent{\includegraphics[width=0.75\linewidth]{C:/Users/mfaso/OneDrive/Documents/GitHub/M3M6AppliedComplexAnalysis/output/figures/Lecture9_12_1.pdf}}
...
\cent{\includegraphics[width=0.7\linewidth]{C:/Users/mfaso/OneDrive/Documents/GitHub/M3M6AppliedComplexAnalysis/output/figures/Lecture9_13_1.pdf}}
