...
\|A \|_2
\]
which equals the largest singular value, that is the square-root of the largest eigenvalue of $A^\top A$. We denote the set of eigenvalues of a square matrix $A$, also known as the spectrum of $A$, by $\sigma(A)$. The \emph{spectral radius} of $A$ is defined as
$$
...
\]
The issue with Taylor series is that it requires analyticity to converge. 
%We can see this clearly for the case $\sqrt{A}$ with Taylor series around $1$:
%
%\[
...
\cent{\includegraphics[width=0.825\linewidth]{C:/Users/mfaso/OneDrive/Documents/GitHub/M3M6AppliedComplexAnalysis/output/figures/Lecture7_1_1.pdf}}
...
\cent{\includegraphics[width=0.6\linewidth]{C:/Users/mfaso/OneDrive/Documents/GitHub/M3M6AppliedComplexAnalysis/output/figures/Lecture7_3_1.pdf}}
...
\cent{\includegraphics[width=0.75\linewidth]{C:/Users/mfaso/OneDrive/Documents/GitHub/M3M6AppliedComplexAnalysis/output/figures/Lecture7_5_1.pdf}}
